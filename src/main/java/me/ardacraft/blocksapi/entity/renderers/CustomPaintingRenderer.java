package me.ardacraft.blocksapi.entity.renderers;
...
public class CustomPaintingRenderer extends Render
{
	 ...
	 */
	public void doRender(EntityCustomPainting painting, double p_76986_2_, double p_76986_4_, double p_76986_6_, float p_76986_8_, float p_76986_9_)
	{
		GL11.glPushMatrix();
		...
		this.func_77010_a(painting, painting.getWidthPixels(), painting.getHeightPixels(), 0, 0);
	 ...
	 */
	protected ResourceLocation getEntityTexture(EntityCustomPainting painting)
	{
		return painting.getResource();
//		return field_110807_a;
	}

	private void func_77010_a(EntityCustomPainting painting, int p_77010_2_, int p_77010_3_, int p_77010_4_, int p_77010_5_)
	{
	...
	private void func_77008_a(EntityCustomPainting p_77008_1_, float p_77008_2_, float p_77008_3_)
	{
	...
	{
		return this.getEntityTexture((EntityCustomPainting)p_110775_1_);
	}
